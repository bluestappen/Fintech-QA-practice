...
| Document                                                | Purpose                                                              |
| ------------------------------------------------------- | -------------------------------------------------------------------- |
| [Test Plan](docs/01-test-plan.md)                       | Defines QA scope, strategy, risks, entry criteria, and exit criteria |
| [Test Scenarios](docs/02-test-scenarios.md)             | Converts requirements and risks into structured test cases           |
| [Business Logic QA](docs/03-business-logic-qa.md)       | Defines financial business rules and validation points               |
| [Bug Reports](docs/04-bug-reports.md)                   | Provides Jira-style sample bug reports                               |
| [SQL Validation](docs/05-sql-validation.md)             | Shows backend data consistency validation examples                   |
| [Release Test Summary](docs/06-release-test-summary.md) | Summarizes test results, risks, and release recommendation           |
| [Mock Requirements](mock-app/requirements.md)           | Defines fictional service requirements used for testing              |
...
1. Money movement consistency
2. Investment order lifecycle consistency
